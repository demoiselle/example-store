...
@NamedQueries({
    ...
    @NamedQuery(name = "Item.findByVendaId", query = "SELECT i FROM Item i WHERE i.vendaId = :vendaId"),
    @NamedQuery(name = "Item.findByProdutoId", query = "SELECT i FROM Item i WHERE i.produtoId = :produtoId"),
...
public class Item implements Serializable {
    ...
    public String toString() {
        return "org.demoiselle.jee7.example.store.sale.entity.Item[ id=" + id + " ]";
    }
